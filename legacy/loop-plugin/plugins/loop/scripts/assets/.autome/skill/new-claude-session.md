...
```bash
bash .autome/skill/new_claude_session.sh "<协议指定的 prompt 原文>"
```

例如：

```bash
bash .autome/skill/new_claude_session.sh "Please execute docs/my-task/my-task-task.md Task 1 additional task 2."
```
